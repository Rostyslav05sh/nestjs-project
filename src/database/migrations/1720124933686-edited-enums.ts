...
export class EditedEnums1720124933686 implements MigrationInterface {
    name = 'EditedEnums1720124933686'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."posts_brand_enum" RENAME TO "posts_brand_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."posts_brand_enum" AS ENUM('bmv', 'daewoo')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."brands_brand_enum" AS ENUM('bmv', 'daewoo')`);
